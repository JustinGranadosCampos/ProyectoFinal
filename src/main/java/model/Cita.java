...
public class Cita {
    ...
    public Cita(int cod_cita, Date fecha_cita, String hora_cita, int id_paciente, int id_distrito, int id_caton, int id_provincia, String sede, int id_usuario, int id_rol, int id_servicio) {
    ...
    public Cita(int cod_cita, Date fecha_cita, String hora_cita, String sede, String cedula, String nombreP, String apellidoP, String nombreProvincia, String nombreMedico, String desc_servicio) {
        this.cod_cita = cod_cita;
        this.fecha_cita = fecha_cita;
        this.hora_cita = hora_cita;
        this.sede = sede;
