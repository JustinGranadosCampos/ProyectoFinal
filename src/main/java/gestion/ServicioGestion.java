...
public class ServicioGestion {
    ...
    private static final String SQL_SELECT_SERVICIO="SELECT * FROM SERVICIO ID_SERVICIO=?";
    ...
    private static final String SQL_DELETE_SERVICIO="UPDATE SERVICIO SET DESC_SERVICIO=?,CODIGO_SERVICIO=?,PRECIO=? WHERE ID_SERVICIO=?";
